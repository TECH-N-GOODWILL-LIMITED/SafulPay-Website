        ...
        <section  id="about-hero" className="relative">
          ...
          <div className="relative z-10 container mx-auto px-6 pt-16 pb-16">
            ...
            >
              ...
              <h2 className="text-[32px] font-bold font-['Outfit'] mb-2">Empowering Financial Freedom</h2>
              <h2 className="text-[32px] font-bold font-['Outfit'] mb-8">with Innovation</h2>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-[40px] font-bold font-['Outfit'] mb-4">
                Meet Our Team of <br /> <span className="text-[#126100]">Experts</span>
              </h2>
              <p className="text-xl font-medium font-['Outfit'] mb-6">Innovators Driving Financial Transformation</p>
