...
function Footer() {
  ...
  return (
    <section className="bg-white flex flex-col gap-14 relative">
      <div className="absolute max-w-screen w-full h-[900px] bottom-0 rounded-t-[50px] bg-[#1B1B1B]"></div>
      <ContactUs />
      {/* <footer className="px-2.5 pt-37.5  rounded-t-[50px] bg-[#1B1B1B]"> */}
