  ...
  return (
    <footer className="rounded-t-[50px] bg-[#1B1B1B] text-white text-start w-full">
      <div className="grid grid-cols-1 justify-between items-center max-w-300.5 mx-auto px-2.5 pt-25 pb-25 gap-x-10 md:pt-37.5 md:grid-cols-[1fr_auto] max-md:place-items-center max-md:text-center max-md:gap-y-10">
            ...
            <div className="flex items-center gap-1.25">
              {socials.map((social, index) => (
                <a
                  href={social.url}
                  key={index}
                  className="w-full p-5 bg-primary-shade-10 rounded-full hover:bg-primary-color max-md:bg-secondary-shade-10"
                >
        ...
        <div className="mt-2.5 flex justify-between items-center col-span-full text-[18px] tracking-[-0.18px] border-t border-white max-md:mx-10 max-md:flex-col-reverse max-md:w-full max-md:gap-10">
